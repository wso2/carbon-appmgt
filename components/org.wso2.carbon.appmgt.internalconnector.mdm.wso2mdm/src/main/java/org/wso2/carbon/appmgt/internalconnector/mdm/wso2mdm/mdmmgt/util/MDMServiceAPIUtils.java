...
public class MDMServiceAPIUtils {
	...
	public static int getTenantId(String tenantDomain) throws MDMException {
		...
		try {
			...
			throw new MDMException("Error obtaining tenant id from tenant domain " + tenantDomain);
		}
	}
	 ...
	 * @throws org.wso2.carbon.appmgt.internalconnector.mdm.wso2mdm.mdmmgt.common.MDMException
	 */
