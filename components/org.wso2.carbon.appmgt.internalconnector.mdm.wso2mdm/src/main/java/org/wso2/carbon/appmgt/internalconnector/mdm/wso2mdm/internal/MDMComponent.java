...
package org.wso2.carbon.appmgt.internalconnector.mdm.wso2mdm.internal;
...
import org.wso2.carbon.appmgt.internalconnector.mdm.wso2mdm.MDMOperationsImpl;
import org.wso2.carbon.appmgt.mobile.interfaces.MDMOperations;

/**
 * @scr.component name="org.wso2.carbon.appmgt.internalconnector.mdm.wso2mdm" immediate="true"
 */
...
public class MDMComponent {
	...
	protected void activate(ComponentContext context) {
		...
		mdmServiceRegistration = bundleContext
				.registerService(MDMOperations.class.getName(), new MDMOperationsImpl(), null);
