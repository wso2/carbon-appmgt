...
package org.wso2.carbon.appmgt.internalconnector.mdm.wso2mdm.mdmmgt.beans;
...
@XmlRootElement public class Profile {
	...
	@XmlElement public int getProfileId() {
		return profileId;
	}
	...
	@XmlElement public String getProfileName() {
		return profileName;
	}
	...
	@XmlElement public Timestamp getCreatedDate() {
		return createdDate;
	}
	...
	@XmlElement public Timestamp getUpdatedDate() {
		return updatedDate;
	}
	...
	@XmlElement public List<ProfileFeature> getProfileFeaturesList() {
