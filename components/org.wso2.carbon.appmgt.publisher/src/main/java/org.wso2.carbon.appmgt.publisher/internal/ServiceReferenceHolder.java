...
public class ServiceReferenceHolder {
    ...
    public AppManagerConfigurationService getAppManagerConfigurationService() {
        return amConfigurationService;
    }

    public void setAppManagerConfigurationService(AppManagerConfigurationService amConfigurationService) {
