...
public class AppMDAO {
     ...
     * @return APIInfoDTO[]
     * @throws org.wso2.carbon.appmgt.api.AppManagementException if failed to get Subscribed APIs
     ...
     *
     * @param apiInfoDTO WebApp info
     * @return APIKeyInfoDTO[]
     * @throws org.wso2.carbon.appmgt.api.AppManagementException if failed to get key info for given WebApp
     */
     ...
     * @throws org.wso2.carbon.appmgt.api.AppManagementException if failed to update the access token
     * @throws org.wso2.carbon.identity.base.IdentityException   if failed to get tenant id
     */
    ...
    /**
     * Validate the provided key against the given WebApp. First it will validate the key is valid , ACTIVE and not
     * expired.
     *
     * @param context     Requested Context
     * @param version     version of the WebApp
     * @param accessToken Provided Access Token
     * @return APIKeyValidationInfoDTO instance with authorization status and tier information if authorized.
     * @throws org.wso2.carbon.appmgt.api.AppManagementException Error when accessing the database or registry.
     */
            ...
            if (rs.next()) {
                ...
                if (requiredAuthenticationLevel.equals(AppMConstants.AUTH_APPLICATION_LEVEL_TOKEN) ||
                    ...
                    if (!(userType.equalsIgnoreCase(requiredAuthenticationLevel))) {
                        keyValidationInfoDTO.setValidationStatus(
                                AppMConstants.KeyValidationStatus.API_AUTH_INCORRECT_ACCESS_TOKEN_TYPE);
                        keyValidationInfoDTO.setAuthorized(false);
                        return keyValidationInfoDTO;
                    }
                }
                ...
                if (AppMConstants.TokenStatus.ACTIVE.equals(status)) {
                    ...
                    if (validityPeriod != Long.MAX_VALUE &&
                            (currentTime - timestampSkew) > (issuedTime + validityPeriod)) {
                        keyValidationInfoDTO.setValidationStatus(
                                AppMConstants.KeyValidationStatus.API_AUTH_ACCESS_TOKEN_EXPIRED);
                        if (log.isDebugEnabled()) {
                    ...
                    keyValidationInfoDTO.setValidationStatus(
                            AppMConstants.KeyValidationStatus.API_AUTH_ACCESS_TOKEN_INACTIVE);
                    if (log.isDebugEnabled()) {
                ...
                keyValidationInfoDTO.setValidationStatus(
                        AppMConstants.KeyValidationStatus.API_AUTH_INVALID_CREDENTIALS);
                if (log.isDebugEnabled()) {
     ...
     *
     * @param appId      webApp Id
     * @param urlMapping request resource of the WebApp
     * @return String roles
     * @throws java.sql.SQLException
     */
    ...
    public Subscription getSubscription(APIIdentifier identifier, int applicationId, String subscriptionTyp) throws
        ...
        try {
            ...
            handleException(String.format("Failed to get subscription for app identifier : %d and application id : %s",
                                          identifier.toString(), identifier), e);
        } finally {
    ...
    public boolean updateSubscription(int subscriptionId, String subscriptionType, String trustedIdps, String subStatus)
            throws
            AppManagementException {
    ...
    public void removeAPISubscription(APIIdentifier identifier, String userID, String applicationName)
        ...
        try {
            ...
            // This query to updates the APM_SUBSCRIPTION table
            String sqlQuery =
                    "DELETE FROM APM_SUBSCRIPTION WHERE APP_ID = ? AND APPLICATION_ID = ? AND " +
     ...
     * @return Subscriber
     * @throws org.wso2.carbon.appmgt.api.AppManagementException if failed to get Subscriber from subscriber id
     */
     ...
     * @throws org.wso2.carbon.appmgt.api.AppManagementException if failed to get subscribers for given provider
     */
     ...
     * @throws org.wso2.carbon.appmgt.api.AppManagementException if failed to update subscriber
     */
     ...
     * @throws org.wso2.carbon.appmgt.api.AppManagementException if failed to check subscribed or not
     */
     ...
     * @throws org.wso2.carbon.appmgt.api.AppManagementException if failed to get UserApplicationAPIUsage for given
     *                                                           provider
     */
    ...
    public int addApplication(Application application, String userId, Connection conn)
        ...
        try {
            ...
            String sqlQuery =
                    "INSERT "
                            +
                            "INTO APM_APPLICATION (NAME, SUBSCRIBER_ID, APPLICATION_TIER, CALLBACK_URL, DESCRIPTION, " +
                            "APPLICATION_STATUS)"
                            + " VALUES (?,?,?,?,?,?)";
        ...
        try {
            ...
            if (recordCount == 0) {
                ...
                if (app.isDefaultVersion()) {
                    ...
                    String existingDefaultVersion = getDefaultVersion(app.getId().getApiName(),
                                                                      app.getId().getProviderName(),
    ...
    public void updateAPI(WebApp api) throws AppManagementException {
        ...
        String query = "UPDATE APM_APP " +
                ...
                "OWNER_ID=(SELECT OWNER_ID FROM BUSINESS_OWNERS WHERE OWNER_NAME =?) " +
                " WHERE APP_PROVIDER = ? AND APP_NAME = ? AND APP_VERSION = ? ";
     ...
     * @throws org.wso2.carbon.appmgt.api.AppManagementException on error in revoking access token
     */
     ...
     * @throws org.wso2.carbon.appmgt.api.AppManagementException on error in getting applications array
     */
    ...
    public int saveEntitlementPolicyPartial(String policyPartialName, String policyPartial, boolean isSharedPartial,
                                            String policyAuthor, String policyPartialDesc, int tenantId)
            throws AppManagementException {
    ...
    public boolean updateEntitlementPolicyPartial(int policyPartialId, String policyPartial
        ...
        Connection connection = null;
        PreparedStatement prepStmt = null;
        String queryToUpdatePolicyPartial =
                "UPDATE APM_ENTITLEMENT_POLICY_PARTIAL SET CONTENT=? ,SHARED=? ,DESCRIPTION=?" +
        ...
        try {
            ...
            if (connection != null) {
                try {
                    ...
                    log.error("Failed to rollback the update of entitlement policy partial with id : " + policyPartial,
                              e1);
                }
            }
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (ruleCondition == null) {
                    log.error(String.format("Can't read content for the policy partial '%s'.",
                                            policyPartial.getPolicyPartialName()));
                    continue;
                } else {
    ...
    public BusinessOwner getBusinessOwner(String appId) throws AppManagementException {
        ...
        String queryToGetBusinessOwner =
                "SELECT BUSINESS_OWNERS.OWNER_ID, BUSINESS_OWNERS.OWNER_NAME, BUSINESS_OWNERS.OWNER_EMAIL, " +
                        "BUSINESS_OWNERS.OWNER_DESC, BUSINESS_OWNERS.OWNER_SITE FROM APM_APP INNER JOIN " +
                        "BUSINESS_OWNERS ON APM_APP.OWNER_ID = BUSINESS_OWNERS.OWNER_ID WHERE UUID = ? ";
    ...
    private String exctractConditionFromPolicyPartialContent(String policyPartialContent) {
        ...
        try {
            ...
            OMElement conditionNode = (OMElement) builder.getDocumentElement().getChildrenWithLocalName("Condition")
                    .next();
    ...
    /**
     * Get the primaryLogin name using secondary login name. Primary secondary Configuration is provided in the
     * identitiy.xml. In the userstore, it is users responsibility TO MAINTAIN THE SECONDARY LOGIN NAME AS UNIQUE for
     * each and every users. If it is not unique, we will pick the very first entry from the userlist.
     *
     * @param login
     * @return
     */
     ...
     */
    private Subscription getIndividualSubscription(String userId, String appContext, String appVersion,
        ...
        try {
            ...
            statementToFindIndividualSubscriptions.setString(++parameterIndex,
            ...
            APIMgtDBUtil.closeAllConnections(statementToFindIndividualSubscriptions, null,
                                             individualSubscriptionResult);
        }
    ...
    private Subscription getEnterpriseSubscription(String appContext, String appVersion, Connection connection) {
        ...
        try {
            ...
            byte parameterIndex = 0;
            statementToFindEnterpriseSubscriptions.setString(++parameterIndex,
                                                             Subscription.SUBSCRIPTION_TYPE_ENTERPRISE);
            ...
            APIMgtDBUtil.closeAllConnections(statementToFindEnterpriseSubscriptions, null,
                                             enterpriseSubscriptionResult);
        }
    ...
    /**
     * This method returns basic webapp details(provider,name,logout url) for given context and version of the webapp
     *
     * @param context    Context of the WebApp
     * @param version    Version of the WebApp
     * @param connection SQL Connection to the data store
    ...
    /**
     * Fetch all the mandatory and mapped Java policy list with the mapped Application Id Only includes the Global
    ...
    public List<String> getApplicableEntitlementPolicyIds(int appId,
                                                          String matchedUrlPattern, String httpVerb)
            throws AppManagementException {
        ...
        try {
            ...
            handleException(
                    String.format("Error while getting applicable entitlement policies for "
                                          + "AppId : %d, URL pattern : %s, HTTP verb : %s", appId, matchedUrlPattern,
                                  httpVerb), e);
        } finally {
            APIMgtDBUtil.closeAllConnections(prepStmt, con, rs);
        }
    ...
    /**
     * This method delete  an entry from APM_FAVOURITE_APPS based on given app detail and username. (remove the given
     * app from favourite app list of given user)
     *
     * @param identifier      API Identifier
     * @param username        Username
     * @param tenantIdOfUser  Tenant Id of Logged in user
