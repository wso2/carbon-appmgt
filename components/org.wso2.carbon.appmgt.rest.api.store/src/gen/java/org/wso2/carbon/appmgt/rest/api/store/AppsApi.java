...
public class AppsApi  {
   ...
   private final AppsApiService delegate = AppsApiServiceFactory.getAppsApi();
    ...
    @POST
    @Path("/{appType}/id/{appId}/favourite/add-to-favourite")
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    ...
    public Response appsAppTypeIdAppIdFavouriteAddToFavouritePost(@ApiParam(value = "App Type. Either webapp or mobileapp",required=true ) @PathParam("appType") String appType,
    @ApiParam(value = "**APP ID** consisting of the **UUID** of the App. \nThe combination of the provider of the app, name of the appId and the version is also accepted as a valid App ID.\nShould be formatted as **provider-name-version**.",required=true ) @PathParam("appId") String appId,
    @ApiParam(value = "Media type of the entity in the body. Default is JSON." ,required=true , defaultValue="JSON")@HeaderParam("Content-Type") String contentType)
    {
    return delegate.appsAppTypeIdAppIdFavouriteAddToFavouritePost(appType,appId,contentType);
    }
    @GET
    @Path("/{appType}/id/{appId}/favourite/favourite-page")
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    ...
    public Response appsAppTypeIdAppIdFavouriteFavouritePageGet(@ApiParam(value = "App Type. Either webapp or mobileapp",required=true ) @PathParam("appType") String appType,
    @ApiParam(value = "**APP ID** consisting of the **UUID** of the App. \nThe combination of the provider of the app, name of the appId and the version is also accepted as a valid App ID.\nShould be formatted as **provider-name-version**.",required=true ) @PathParam("appId") String appId,
    @ApiParam(value = "Media types acceptable for the response. Default is JSON."  , defaultValue="JSON")@HeaderParam("Accept") String accept,
    @ApiParam(value = "Validator for conditional requests; based on the ETag of the formerly retrieved\nvariant of the resourec."  )@HeaderParam("If-None-Match") String ifNoneMatch,
    @ApiParam(value = "Validator for conditional requests; based on Last Modified header of the \nformerly retrieved variant of the resource."  )@HeaderParam("If-Modified-Since") String ifModifiedSince)
    {
    return delegate.appsAppTypeIdAppIdFavouriteFavouritePageGet(appType,appId,accept,ifNoneMatch,ifModifiedSince);
    }
    @POST
    @Path("/{appType}/id/{appId}/favourite/favourite-page")
    @Consumes({ "application/json" })
    ...
    public Response appsAppTypeIdAppIdFavouriteFavouritePagePost(@ApiParam(value = "App Type. Either webapp or mobileapp",required=true ) @PathParam("appType") String appType,
    @ApiParam(value = "**APP ID** consisting of the **UUID** of the App. \nThe combination of the provider of the app, name of the appId and the version is also accepted as a valid App ID.\nShould be formatted as **provider-name-version**.",required=true ) @PathParam("appId") String appId,
    @ApiParam(value = "Media type of the entity in the body. Default is JSON." ,required=true , defaultValue="JSON")@HeaderParam("Content-Type") String contentType)
    {
    return delegate.appsAppTypeIdAppIdFavouriteFavouritePagePost(appType,appId,contentType);
    }
    @DELETE
    @Path("/{appType}/id/{appId}/favourite/favourite-page")
    @Consumes({ "application/json" })
    ...
    public Response appsAppTypeIdAppIdFavouriteFavouritePageDelete(@ApiParam(value = "App Type. Either webapp or mobileapp",required=true ) @PathParam("appType") String appType,
    @ApiParam(value = "**APP ID** consisting of the **UUID** of the App. \nThe combination of the provider of the app, name of the appId and the version is also accepted as a valid App ID.\nShould be formatted as **provider-name-version**.",required=true ) @PathParam("appId") String appId,
    @ApiParam(value = "Media type of the entity in the body. Default is JSON." ,required=true , defaultValue="JSON")@HeaderParam("Content-Type") String contentType)
    {
    return delegate.appsAppTypeIdAppIdFavouriteFavouritePageDelete(appType,appId,contentType);
    }
    @POST
    @Path("/{appType}/id/{appId}/favourite/remove-from-favourite")
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    ...
    public Response appsAppTypeIdAppIdFavouriteRemoveFromFavouritePost(@ApiParam(value = "App Type. Either webapp or mobileapp",required=true ) @PathParam("appType") String appType,
    @ApiParam(value = "**APP ID** consisting of the **UUID** of the App. \nThe combination of the provider of the app, name of the appId and the version is also accepted as a valid App ID.\nShould be formatted as **provider-name-version**.",required=true ) @PathParam("appId") String appId,
    @ApiParam(value = "Media type of the entity in the body. Default is JSON." ,required=true , defaultValue="JSON")@HeaderParam("Content-Type") String contentType)
    {
    return delegate.appsAppTypeIdAppIdFavouriteRemoveFromFavouritePost(appType,appId,contentType);
    }
    @GET
