...
public abstract class AppsApiService {
    ...
    public abstract Response appsAppTypeIdAppIdFavouriteAddToFavouritePost(String appType,String appId,String contentType);
    public abstract Response appsAppTypeIdAppIdFavouriteFavouritePageGet(String appType,String appId,String accept,String ifNoneMatch,String ifModifiedSince);
    public abstract Response appsAppTypeIdAppIdFavouriteFavouritePagePost(String appType,String appId,String contentType);
    public abstract Response appsAppTypeIdAppIdFavouriteFavouritePageDelete(String appType,String appId,String contentType);
    public abstract Response appsAppTypeIdAppIdFavouriteRemoveFromFavouritePost(String appType,String appId,String contentType);
