...
public abstract class AppsApiService {
    public abstract Response appsDownloadPost(String contentType,DownloadDTO download);
    public abstract Response appsUninstallationPost(String contentType,DownloadDTO download);
