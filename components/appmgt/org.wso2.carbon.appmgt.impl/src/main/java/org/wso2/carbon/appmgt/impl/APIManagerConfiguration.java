...
public class APIManagerConfiguration {
    ...
    public void load(String filePath) throws APIManagementException {
        ...
        try {
            ...
            throw new APIManagementException("I/O error while reading the WebApp manager " +
                    "configuration: " + filePath, e);
        } catch (XMLStreamException e) {
            throw new APIManagementException("Error while parsing the WebApp manager " +
                    "configuration: " + filePath, e);
        } finally {
            ...
            if (elementHasText(element)) {
                ...
                while(apistoreIterator.hasNext()){
                    ...
                    store.setUsername(replaceSystemProperty(
                        ...
                        try {
                            throw new APIManagementException("The user-credentials of WebApp Publisher is not defined in the <ExternalAPIStore> config of api-manager.xml.");
                        } catch (APIManagementException e) {
                            //ignore
                        }
                    }
