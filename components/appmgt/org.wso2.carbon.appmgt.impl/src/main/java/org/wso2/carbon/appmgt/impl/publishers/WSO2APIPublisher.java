...
public class WSO2APIPublisher implements APIPublisher {
    ...
    private boolean deleteWSO2Store(APIIdentifier apiId, String externalPublisher, String storeEndpoint, HttpContext httpContext) throws APIManagementException {
        ...
        try {
            ...
            throw new APIManagementException("Error while deleting the WebApp : "+ apiId.getApiName() +" from the external WSO2 APIStore : "+storeEndpoint + e);
    ...
    private boolean addAPIToStore(WebApp api,String storeEndpoint,String externalPublisher, HttpContext httpContext) throws APIManagementException {
        boolean added=false;
        HttpClient httpclient = new DefaultHttpClient();
        if(storeEndpoint.contains("/store")){
        ...
        try {
            ...
            throw new APIManagementException("Error while adding the WebApp:"+ api.getId().getApiName()+" to the external WSO2 APIStore:"+storeEndpoint + e);
    ...
    private boolean updateWSO2Store(WebApp api, String externalPublisher, String storeEndpoint, HttpContext httpContext) throws APIManagementException {
        boolean updated=false;
        HttpClient httpclient = new DefaultHttpClient();
        if(storeEndpoint.contains("/store")){
            storeEndpoint=storeEndpoint.split("store")[0]+"publisher"+APIConstants.APISTORE_ADD_URL;
        ...
        try {
            ...
            throw new APIManagementException("Error while updating the WebApp: "+ api.getId().getApiName()+" in the external WSO2 APIStore: "+storeEndpoint + e);
    ...
    private boolean publishAPIToStore(APIIdentifier apiId,String storeEndpoint,String externalPublisher, HttpContext httpContext) throws APIManagementException {
        ...
        try {
            ...
            throw new APIManagementException("Error while publishing the WebApp: "+apiId.getApiName()+" to the external WSO2 APIStore : "+storeEndpoint + e);
