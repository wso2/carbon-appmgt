...
//                    "   RR.REG_LAST_UPDATED_TIME DESC ";
    ...
    public List<WebApp> getAllAPIs() throws APIManagementException {
    ...
    public WebApp getAPI(APIIdentifier identifier) throws APIManagementException {
    ...
    public WebApp getAPI(String apiPath) throws APIManagementException {
        try {
            GenericArtifactManager artifactManager = APIUtil.getArtifactManager(registry,
                                                                                APIConstants.API_KEY);
            Resource apiResource = registry.get(apiPath);
    ...
    public Set<String> getAPIVersions(String providerName, String apiName)
        ...
        try {
            ...
            if (resource instanceof Collection) {
                ...
                throw new APIManagementException("WebApp version must be a collection " + apiName);
            }
        } catch (RegistryException e) {
    ...
    public Set<WebApp> getSubscriberAPIs(Subscriber subscriber) throws APIManagementException {
	        ...
	        for (SubscribedAPI subscribedAPI : subscribedAPIs) {
	            ...
	            try {
	                ...
	                GenericArtifact artifact = artifactManager.getGenericArtifact(
	                        resource.getUUID());
	                WebApp api = APIUtil.getAPI(artifact, registry);
    ...
    public WebApp getAPI(APIIdentifier identifier,APIIdentifier oldIdentifier) throws APIManagementException {
        String apiPath = APIUtil.getAPIPath(identifier);
        try {
            GenericArtifactManager artifactManager = APIUtil.getArtifactManager(registry,
                                                                                APIConstants.API_KEY);
