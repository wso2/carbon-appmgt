...
import org.wso2.carbon.appmgt.gateway.handlers.security.APIKeyValidator;
...
/**
 * This WebApp handler is responsible for evaluating authenticated user requests against their
    ...
    private boolean doRoleBasedAccessThrottling(MessageContext synCtx, ConfigurationContext cc) {
        ...
        if (!synCtx.isResponse()) {
            ...
            if (config != null) {
                ...
                //get WebApp context from incoming request
                apiContext = (String) synCtx.getProperty(RESTConstants.REST_API_CONTEXT);
                //get WebApp version from incoming request
                ...
                //---------------Start of WebApp level throttling------------------
