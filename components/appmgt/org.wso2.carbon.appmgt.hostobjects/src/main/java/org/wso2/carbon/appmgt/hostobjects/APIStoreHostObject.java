...
public class APIStoreHostObject extends ScriptableObject {
    ...
    public static NativeObject jsFunction_getApplicationKey(Context cx, Scriptable thisObj,
        ...
        if (args != null && args.length!=0) {
            ...
            try {
                ...
                row.put("validityTime", row, dto.getValidityTime());
    ...
    public static NativeObject jsFunction_validateWFPermission(Context cx, Scriptable thisObj,
        ...
        //String url = config.getFirstProperty(APIConstants.AUTH_MANAGER_URL);
        //if (url == null) {
        //    throw new APIManagementException("WebApp key manager URL unspecified");
        //}
    ...
    public static String jsFunction_addSubscription(Context cx,
        ...
        try {
	        ...
	        if (!isTierAllowed) {
	    		throw new APIManagementException("Tier " + tier + " is not allowed for WebApp " + apiName + "-" + version + ". Only "
    ...
    public static NativeArray jsFunction_removeAPIRating(Context cx,
        ...
        if (args != null && args.length != 0) {
            ...
            try {
                ...
                throw new APIManagementException("Error while remove User Rating of the WebApp " + apiName
                          + e);

            } catch (Exception e) {
                throw new APIManagementException("Error while remove User Rating of the WebApp  " + apiName + e);
	        ...
	        for (SubscribedAPI subscribedAPI : subscribedAPIs) {
	            ...
	            if (apisArray == null) {
	                ...
	                if (prodKey != null) {
	                    ...
	                    //appObj.put("prodValidityRemainingTime", appObj, apiMgtDAO.getApplicationAccessTokenRemainingValidityPeriod(prodKey.getAccessToken()));
	                } else {
	                ...
	                if (sandboxKey != null) {
	                   ...
	                   // appObj.put("sandValidityRemainingTime", appObj, apiMgtDAO.getApplicationAccessTokenRemainingValidityPeriod(sandboxKey.getAccessToken()));
	                } else {
    ...
    private static void removeUser(String username, APIManagerConfiguration config, String serverURL) throws RemoteException, UserAdminUserAdminException {
