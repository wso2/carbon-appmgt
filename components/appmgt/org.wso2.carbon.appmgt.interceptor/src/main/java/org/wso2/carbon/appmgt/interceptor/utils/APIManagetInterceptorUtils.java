 ...
 * under the License.
 */
package org.wso2.carbon.appmgt.interceptor.utils;
...
public class APIManagetInterceptorUtils {
	...
	public static void handleNoMatchAuthSchemeCallForAxisservice(MessageContext msgContext,
		...
		String errrMsg = "Resource is not matched for HTTP Verb " + httpVerb + ". WebApp context " +
