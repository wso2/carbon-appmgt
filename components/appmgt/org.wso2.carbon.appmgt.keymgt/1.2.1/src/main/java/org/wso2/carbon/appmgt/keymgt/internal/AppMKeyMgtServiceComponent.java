...
package org.wso2.carbon.appmgt.keymgt.internal;
...
import org.wso2.carbon.appmgt.keymgt.service.thrift.APIKeyMgtException;
import org.wso2.carbon.appmgt.keymgt.service.thrift.APIKeyValidationServiceImpl;
import org.wso2.carbon.appmgt.keymgt.util.APIKeyMgtDataHolder;
 ...
 */
public class AppMKeyMgtServiceComponent {

    private static Log log = LogFactory.getLog(AppMKeyMgtServiceComponent.class);
        ...
        try {
            ...
            if (APIKeyMgtDataHolder.getThriftServerEnabled()) {
                ...
                if (log.isDebugEnabled()) {
                    log.debug("WebApp key validation thrift server is disabled");
                }
            }
            if (log.isDebugEnabled()) {
                log.debug("Identity WebApp Key Mgt Bundle is started.");
            }
        } catch (Exception e) {
    ...
    protected void setRegistryService(RegistryService registryService) {
        ...
        if (log.isDebugEnabled()) {
            log.debug("Registry Service is set in the WebApp KeyMgt bundle.");
        }
    }
    ...
    protected void unsetRegistryService(RegistryService registryService) {
        ...
        if (log.isDebugEnabled()) {
            log.debug("Registry Service is unset in the WebApp KeyMgt bundle.");
        }
    }
    ...
    protected void setRealmService(RealmService realmService) {
        ...
        if (log.isDebugEnabled()) {
            log.debug("Realm Service is set in the WebApp KeyMgt bundle.");
        }
    }
    ...
    protected void unsetRealmService(RealmService realmService) {
        ...
        if (log.isDebugEnabled()) {
            log.debug("Realm Service is unset in the WebApp KeyMgt bundle.");
        }
    }

    protected void setAPIManagerConfigurationService(AppManagerConfigurationService amcService) {
        if (log.isDebugEnabled()) {
            log.debug("WebApp manager configuration service bound to the WebApp handlers");
        }
    ...
    protected void unsetAPIManagerConfigurationService(AppManagerConfigurationService amcService) {
        if (log.isDebugEnabled()) {
            log.debug("WebApp manager configuration service unbound from the WebApp handlers");
        }
        ...
        try {
            ...
            String thriftPortString =
                    APIKeyMgtDataHolder.getAmConfigService().getAPIManagerConfiguration().getFirstProperty(
                            AppMConstants.API_KEY_MANGER_THRIFT_SERVER_PORT);
            ...
            String thriftHostString =
                    APIKeyMgtDataHolder.getAmConfigService().getAPIManagerConfiguration().getFirstProperty(
                    AppMConstants.API_KEY_MANGER_THRIFT_SERVER_HOST);
            ...
            String thriftClientTimeOut =
                    APIKeyMgtDataHolder.getAmConfigService().getAPIManagerConfiguration().getFirstProperty(
                    AppMConstants.API_KEY_MANGER_CONNECTION_TIMEOUT);
