...
public class APIKeyMgtUtil {
    ...
    /**
     * This returns WebApp object for given APIIdentifier. Reads from registry entry for given APIIdentifier
     * creates WebApp object
     *
     * @param identifier APIIdentifier object for the WebApp
     * @return WebApp object for given identifier
     * @throws org.wso2.carbon.appmgt.api.AppManagementException on error in getting WebApp artifact
     */
    public static WebApp getAPI(APIIdentifier identifier) throws AppManagementException {
