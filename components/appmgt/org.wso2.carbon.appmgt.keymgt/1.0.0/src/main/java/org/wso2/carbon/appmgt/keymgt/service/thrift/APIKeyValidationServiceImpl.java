...
public class APIKeyValidationServiceImpl extends AbstractAdmin
    ...
    public APIKeyValidationInfoDTO validateKey(String context, String version, String accessToken,
            ...
            throws APIKeyMgtException, AppManagementException, TException {
        ...
        try {
            if (thriftAuthenticatorService != null && apiKeyValidationService != null) {
                ...
                if (thriftAuthenticatorService.isAuthenticated(sessionId)) {
                    ...
                    try {
                        ...
                        org.wso2.carbon.appmgt.impl.dto.APIKeyValidationInfoDTO keyValidationInfoDTO =
            ...
            throw new org.wso2.carbon.appmgt.keymgt.service.thrift.APIKeyMgtException(e.getMessage());
            ...
            if (thriftAuthenticatorService != null && apiKeyValidationService != null) {
                ...
                if (thriftAuthenticatorService.isAuthenticated(sessionId)) {
                    ...
                    try {
                        ...
                        ArrayList<org.wso2.carbon.appmgt.api.model.URITemplate> uriTemplates =
                                apiKeyValidationService.getAllURITemplates(context, apiVersion);

                        for (org.wso2.carbon.appmgt.api.model.URITemplate aDto : uriTemplates) {
    ...
    private URITemplate toTemplates(
            org.wso2.carbon.appmgt.api.model.URITemplate dto) {
