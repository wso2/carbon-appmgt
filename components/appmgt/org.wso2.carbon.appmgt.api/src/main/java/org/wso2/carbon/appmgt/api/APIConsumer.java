...
public interface APIConsumer extends APIManager {
     ...
     * @throws APIManagementException if failed to WebApp set
     */
 ...
 /**
     ...
     */
    public Set<WebApp> getRecentlyAddedAPIs(int limit,String tenantDomain) throws APIManagementException;
     ...
     * @throws APIManagementException If an error occurs while rating the WebApp
     */
     ...
     * @return Set<WebApp>
     * @throws APIManagementException if failed to get WebApp for subscriber
     */
     ...
     * @throws APIManagementException if failed to add comment for WebApp
     */
    ...
    public Set<WebApp> searchAPI(String searchTerm, String searchType,String tenantDomain) throws APIManagementException;
     ...
     * @throws APIManagementException if failed to get set of WebApp
     */
    public Set<WebApp> getPublishedAPIsByProvider(String providerId,String loggedUser, int limit) throws APIManagementException;/**
     ...
     * @throws APIManagementException if failed to get set of WebApp
     */
    public Set<WebApp> getPublishedAPIsByProvider(String providerId, int limit) throws APIManagementException;
