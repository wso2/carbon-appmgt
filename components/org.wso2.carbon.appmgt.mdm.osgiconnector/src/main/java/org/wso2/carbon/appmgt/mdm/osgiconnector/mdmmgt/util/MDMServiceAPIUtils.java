...
public class MDMServiceAPIUtils {
	...
	public static int getTenantId(String tenantDomain) throws DeviceApplicationException {
		PrivilegedCarbonContext ctx = PrivilegedCarbonContext.getThreadLocalCarbonContext();
		RealmService realmService = (RealmService) ctx.getOSGiService(RealmService.class, null);
		try {
			return realmService.getTenantManager().getTenantId(tenantDomain);
		} catch (UserStoreException e) {
			throw new DeviceApplicationException("Error obtaining tenant id from tenant domain " + tenantDomain);
		}
	}

	public static UserStoreManager getUserStoreManager(int tenantId) throws
		...
		try {
			...
			log.error(msg, e);
			throw new DeviceApplicationException(msg, e);
		}
	 ...
	 *
	 * @return the UserRealm of current tenant
	 * @throws DeviceApplicationException
	 */
	public static UserRealm getUserRealm(int tenantId) throws DeviceApplicationException {
		RealmService realmService;
		UserRealm realm;
		try {
			...
			if (realmService == null) {
				...
				log.error(msg);
				throw new DeviceApplicationException(msg);
			}
	...
	public static AuthorizationManager getAuthorizationManager(int tenantId) throws
	                                                                         DeviceApplicationException {
		RealmService realmService;
		...
		try {
			...
			authorizationManager = realmService.getTenantUserRealm(tenantId).
