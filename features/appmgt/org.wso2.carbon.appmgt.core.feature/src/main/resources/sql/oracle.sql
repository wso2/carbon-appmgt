...
CREATE OR REPLACE TRIGGER APPMGR_APP_TRIGGER
                    ...
                    FOR EACH ROW
                    BEGIN
                    SELECT APPMGR_APP_SEQUENCE.nextval INTO :NEW.API_ID FROM dual;
                    END;
/
...
CREATE TABLE AM_SUBSCRIPTION (
    ...
    FOREIGN KEY(API_ID) REFERENCES APPMGR_APP(API_ID) ON DELETE CASCADE,
