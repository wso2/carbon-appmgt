var resources = function(page, meta) {
	...
	return {
		js : ['edit.asset.js', '/logic/asset.tag.edit.js', 'bootstrap-select.min.js','options.text.js',
            'codemirror/codemirror.js', 'codemirror/show-hint.js', 'codemirror/xml-hint.js', 'codemirror/xml.js',
            'resource-common.js', 'resource-edit.js',
            'policy.group.js', 'java.policy.js', 'publisher.placeholder.js', 'select2.min.js'],
		css : ['bootstrap-select.min.css',  'codemirror/codemirror.css', 'select2.min.css']
	};
