...
CREATE TABLE IF NOT EXISTS BUSINESS_OWNER(
 ...
 CREATE TABLE IF NOT EXISTS APM_APP (
     ...
     PRIMARY KEY(APP_ID),
     FOREIGN KEY(BUSINESS_OWNER_ID) REFERENCES BUSINESS_OWNER(OWNER_ID),
     UNIQUE (APP_PROVIDER,APP_NAME,APP_VERSION,TRACKING_CODE,UUID)
 );


CREATE TABLE IF NOT EXISTS  BUSINESS_OWNER_CUSTOM_PROPERTIES(
OWNER_ID INTEGER,
KEY VARCHAR(200) NOT NULL,
VALUE VARCHAR(300) NOT NULL,
FOREIGN KEY(OWNER_ID) REFERENCES BUSINESS_OWNER(OWNER_ID)
);
