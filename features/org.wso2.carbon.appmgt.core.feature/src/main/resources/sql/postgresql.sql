CREATE SEQUENCE IF NOT EXISTS IDN_OAUTH_CONSUMER_APPS_SEQUENCE  START WITH 1 INCREMENT BY 1;
CREATE TABLE IF NOT EXISTS IDN_OAUTH_CONSUMER_APPS (
	    ID INTEGER DEFAULT NEXTVAL('idn_oauth_consumer_apps'),
...
CREATE SEQUENCE APM_SUBSCRIBER_SEQUENCE START WITH 1 INCREMENT BY 1;
CREATE TABLE IF NOT EXISTS APM_SUBSCRIBER (
    SUBSCRIBER_ID INTEGER DEFAULT nextval('apm_subscriber_sequence'),
...
CREATE SEQUENCE APM_APPLICATION_SEQUENCE START WITH 1 INCREMENT BY 1 ;
CREATE TABLE IF NOT EXISTS APM_APPLICATION (
    APPLICATION_ID INTEGER DEFAULT nextval('apm_application_sequence'),
    NAME VARCHAR(100),
...
DROP SEQUENCE IF EXISTS APM_BUSINESS_OWNER_SEQUENCE;
...
DROP SEQUENCE IF EXISTS APM_BUSINESS_PROPERTY_SEQUENCE;
...
CREATE SEQUENCE APM_APP_SEQUENCE START WITH 1 INCREMENT BY 1;
CREATE TABLE IF NOT EXISTS APM_APP (
     APP_ID INTEGER DEFAULT nextval('apm_app_sequence'),
...
CREATE SEQUENCE APM_POLICY_GROUP_SEQUENCE START WITH 1 INCREMENT BY 1;
CREATE TABLE IF NOT EXISTS APM_POLICY_GROUP
(
        POLICY_GRP_ID INTEGER DEFAULT nextval('apm_policy_group_sequence'),
	NAME VARCHAR(256),
...
CREATE SEQUENCE APM_APP_URL_MAPPING_SEQUENCE START WITH 1 INCREMENT BY 1;
CREATE TABLE IF NOT EXISTS APM_APP_URL_MAPPING
(
    URL_MAPPING_ID INTEGER DEFAULT nextval('apm_app_url_mapping_sequence'),
    APP_ID INTEGER NOT NULL,
...
CREATE SEQUENCE APM_ENTITLEMENT_POLICY_PARTIAL_SEQUENCE START WITH 1 INCREMENT BY 1;
CREATE TABLE IF NOT EXISTS APM_ENTITLEMENT_POLICY_PARTIAL
(
    ENTITLEMENT_POLICY_PARTIAL_ID INTEGER DEFAULT nextval('apm_entitlement_policy_partial_sequence'),
...
CREATE SEQUENCE APM_SUBSCRIPTION_SEQUENCE START WITH 1 INCREMENT BY 1;
CREATE TABLE IF NOT EXISTS APM_SUBSCRIPTION (
    SUBSCRIPTION_ID INTEGER DEFAULT nextval('apm_subscription_sequence'),
...
CREATE SEQUENCE APM_APP_LC_EVENT_SEQUENCE START WITH 1 INCREMENT BY 1;
CREATE TABLE IF NOT EXISTS APM_APP_LC_EVENT
(
    EVENT_ID INTEGER DEFAULT nextval('apm_app_lc_event_sequence'),
    APP_ID INTEGER NOT NULL,
...
CREATE SEQUENCE APM_TIER_PERMISSIONS_SEQUENCE START WITH 1 INCREMENT BY 1;
CREATE TABLE IF NOT EXISTS APM_TIER_PERMISSIONS
(
    TIER_PERMISSIONS_ID INTEGER DEFAULT nextval('apm_tier_permissions_sequence'),
...
CREATE SEQUENCE APM_WORKFLOWS_SEQUENCE START WITH 1 INCREMENT BY 1;
CREATE TABLE IF NOT EXISTS APM_WORKFLOWS
(
	WF_ID INTEGER DEFAULT nextval('apm_workflows_sequence'),
...
CREATE SEQUENCE APM_API_CONSUMER_APPS_SEQUENCE START WITH 1 INCREMENT BY 1;
CREATE TABLE IF NOT EXISTS APM_API_CONSUMER_APPS
(
	 ID INTEGER DEFAULT nextval('apm_api_consumer_apps_sequence'),
	 SAML2_SSO_ISSUER varchar(500),
...
CREATE SEQUENCE APM_APP_JAVA_POLICY_SEQUENCE START WITH 1 INCREMENT BY 1;
CREATE TABLE IF NOT EXISTS APM_APP_JAVA_POLICY
(
	JAVA_POLICY_ID INTEGER DEFAULT nextval('apm_app_java_policy_sequence'),
...
CREATE TABLE IF NOT EXISTS APM_EXTERNAL_STORES (
    APP_STORE_ID INTEGER DEFAULT nextval('apm_external_stores_sequence'),
    APP_ID INTEGER,
...
CREATE SEQUENCE APM_FAVOURITE_APPS_SEQUENCE START WITH 1 INCREMENT BY 1;
CREATE TABLE IF NOT EXISTS APM_FAVOURITE_APPS (
   ID INTEGER DEFAULT nextval('apm_favourite_apps_sequence'),
   USER_ID VARCHAR(50) NOT NULL,
   TENANT_ID INTEGER NOT NULL,
   APP_ID INTEGER NOT NULL,
...
CREATE SEQUENCE APM_STORE_FAVOURITE_PAGE_SEQUENCE START WITH 1 INCREMENT BY 1;
CREATE TABLE IF NOT EXISTS APM_STORE_FAVOURITE_PAGE (
   ID INTEGER DEFAULT nextval('apm_store_favourite_page_sequence'),
   USER_ID VARCHAR(50) NOT NULL,
...
CREATE SEQUENCE APM_ONE_TIME_DOWNLOAD_LINK_SEQUENCE START WITH 1 INCREMENT BY 1;
CREATE TABLE IF NOT EXISTS APM_ONE_TIME_DOWNLOAD_LINK(
     ID INTEGER DEFAULT nextval('apm_one_time_download_link_sequence'),
...
CREATE INDEX IF NOT EXISTS IDX_SUB_APP_ID ON APM_SUBSCRIPTION (APPLICATION_ID, SUBSCRIPTION_ID);
