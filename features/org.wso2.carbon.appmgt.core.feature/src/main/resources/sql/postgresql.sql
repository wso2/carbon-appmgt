...
CREATE TABLE IF NOT EXISTS APM_BUSINESS_OWNER_PROPERTY(
  OWNER_PROP_ID BIGSERIAL PRIMARY KEY,
...
( 
      POLICY_GRP_ID BIGSERIAL PRIMARY KEY,
      NAME VARCHAR(256),
...
CREATE TABLE IF NOT EXISTS APM_APP_URL_MAPPING (
    URL_MAPPING_ID BIGSERIAL PRIMARY KEY,
    APP_ID INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS APM_ENTITLEMENT_POLICY_PARTIAL (
    ENTITLEMENT_POLICY_PARTIAL_ID BIGSERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS APM_TIER_PERMISSIONS (
    TIER_PERMISSIONS_ID BIGSERIAL PRIMARY KEY,
...
(
JAVA_POLICY_ID BIGSERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS APM_EXTERNAL_STORES(
    APP_STORE_ID BIGSERIAL PRIMARY KEY,
    APP_ID INTEGER,
...
CREATE TABLE IF NOT EXISTS APM_APP_DEFAULT_VERSION(
    DEFAULT_VERSION_ID BIGSERIAL PRIMARY KEY,
    APP_NAME VARCHAR(256),
    APP_PROVIDER VARCHAR(256),
