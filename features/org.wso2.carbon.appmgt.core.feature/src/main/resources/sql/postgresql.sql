...
DROP SEQUENCE IF EXISTS AM_SUBSCRIBER_SEQUENCE;
...
DROP SEQUENCE IF EXISTS AM_APPLICATION_SEQUENCE;
...
DROP TABLE IF EXISTS APPMGR_APP;
DROP SEQUENCE IF EXISTS APPMGR_APP_SEQUENCE;
...
DROP TABLE IF EXISTS APPMGR_APP_URL_MAPPING;
DROP SEQUENCE IF EXISTS APPMGR_APP_URL_MAPPING_SEQUENCE;
...
DROP SEQUENCE IF EXISTS AM_SUBSCRIPTION_SEQUENCE;
...
DROP TABLE IF EXISTS APPMGR_APP_LC_EVENT;
DROP SEQUENCE IF EXISTS APPMGR_LC_EVENT_SEQUENCE;
...
DROP TABLE IF EXISTS APPMGR_APP_COMMENTS;
DROP SEQUENCE IF EXISTS APPMGR_APP_COMMENTS_SEQUENCE;
...
DROP SEQUENCE IF EXISTS AM_WORKFLOWS_SEQUENCE;
...
DROP TABLE IF EXISTS APPMGR_APP_RATINGS;
DROP SEQUENCE IF EXISTS APPMGR_APP_RATINGS_SEQUENCE;
...
DROP SEQUENCE IF EXISTS AM_TIER_PERMISSIONS_SEQUENCE;
...
DROP SEQUENCE IF EXISTS AM_EXTERNAL_STORES_SEQUENCE;
...
DROP SEQUENCE IF EXISTS APM_APP_DEFAULT_VERSION_SEQUENCE;
