$(document).ready(function(){
    $('.js_startBtn').click(function(){
        ...
        jagg.post("/site/blocks/task-manager/ajax/task.jag", { action:"startTask",taskId:taskId,taskType:"publishapp" },
            function (json) {
                if (!json.error) {
                    btn.next().show();
    ...
    $('.js_completeBtn').click(function(){
        ...
        btn.attr("disabled","disabled");
        jagg.post("/site/blocks/task-manager/ajax/task.jag", { action:"completeTask",status:status,taskId:taskId,taskType:"publishapp",description:description },
            function (json) {
                if (!json.error) {
                    btn.next().show();
    ...
    $('.js_assignBtn').click(function(){
        ...
        var iteration=btn.attr("iteration");
        btn.attr("disabled","disabled");
        jagg.post("/site/blocks/task-manager/ajax/task.jag", { action:"assignTask",taskId:taskId,taskType:"publishapp" },
            function (json) {
                if (!json.error) {
                    btn.next().show();
