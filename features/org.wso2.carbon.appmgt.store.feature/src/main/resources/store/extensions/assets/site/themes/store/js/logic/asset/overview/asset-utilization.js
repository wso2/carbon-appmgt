$(function(){
    ...
    var API_URL='/store/resources/site/v1/subscription/app';
    var API_UNSUBSCRIPTION_URL='/store/resources/site/v1/unsubscription/app';
    var API_SUBSCRIPTION_WORKFLOW = '/store/resources/site/v1/subscription-workflow/app';
